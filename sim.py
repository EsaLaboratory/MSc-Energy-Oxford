...
#import optimizers from optimizer_MILP
from optimizers.optimizer_MILP import optimizer_no_limits
from optimizers.optimizer_MILP import optimizer_no_aging
from optimizers.optimizer_MILP import optimizer_daily_limit
from optimizers.optimizer_MILP import optimizer_cyc_aging
from optimizers.optimizer_MILP import optimizer_pl_aging
...
class BiddingSim():
    def __init__(self, config_sim: ConfigParser, config_opt: ConfigParser, config_ana: ConfigParser):
        ...
        self.__aging_cost_GBP_per_MWh = float(self.__config_opt['GENERAL']['AGING_COST_MWh'])
    ...
    def run(self):
        ...
        for day in range(self.__no_of_days):
            ...
            optimal_baseline_discharge_MW, soc_results, cycles = optimizer_pl_aging(self.__horizon_length*24, 
                    ...
                    self.__aging_cost_GBP_per_MWh,0.95)
        ...
        results.to_csv('results/0801/gurobi_pl_aging_60s_full_run.csv')
        print('Done!')
        self.simses.close()
